...
import AccountDetailsEdit from "../screens/AccountDetailsEdit"
/**
...
const StackNavigator = () => {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen
        name="AccountEdit"
        component={gestureHandlerRootHOC(AccountDetailsEdit)}
        options={{
          title: "Edit account",
          headerStyle: {
            backgroundColor:
      ...
      <Stack.Screen
        ...
        options={{
          ...
          headerLeft: () => <HeaderBackButtonWithCustomAction />,
        }}
      />
      <Stack.Screen
        name="TerminatedCard"
