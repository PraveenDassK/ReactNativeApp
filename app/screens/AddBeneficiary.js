      ...
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <View style= {{justifyContent: "space-between"}}>
          ...
          <View style={{ width: "90%", marginLeft: "5%", marginBottom: "5%"}}>
            ...
            <TextInput placeholder="Master Splinter" style={{ fontWeight: "700", fontSize: 24, marginTop: "1%",}}></TextInput>
            <View style={{ height: 1, backgroundColor: "black", marginTop: "1%" }} />
          </View>

          <View style={{ width: "90%", marginLeft: "5%", marginBottom: "5%" }}>
            <Text style={{ fontSize: 14 }}>Phone Number</Text>
            <TextInput placeholder="01489424242" style={{ fontWeight: "700", fontSize: 24, marginTop: "1%" }}></TextInput>
            <View style={{ height: 1, backgroundColor: "black", marginTop: "1%" }} />
          </View>

          <View style={{ width: "90%", marginLeft: "5%", marginBottom: "5%" }}>
            <Text  style={{ fontSize: 14 }}>Account Owner Name</Text>
            <TextInput placeholder="Spaff Jezos" style={{ fontWeight: "700", fontSize: 24, marginTop: "1%" }}></TextInput>
            <View style={{ height: 1, backgroundColor: "black", marginTop: "1%" }} />
          </View>

          <View style={{ width: "90%", marginLeft: "5%", marginBottom: "5%" }}>
            <Text style={{ fontSize: 14 }}>Account Number</Text>
            <TextInput placeholder="4242-4242" style={{ fontWeight: "700", fontSize: 24, marginTop: "1%" }}></TextInput>
            <View style={{ height: 1, backgroundColor: "black", marginTop: "1%" }} />
          </View>

          <View style={{ width: "90%", marginLeft: "5%", marginBottom: "5%" }}>
            <Text style={{ fontSize: 14 }}>Sort Code</Text>
            <TextInput placeholder="00-00-00" style={{ fontWeight: "700", fontSize: 24, marginTop: "1%" }}></TextInput>
            <View style={{ height: 1, backgroundColor: "black", marginTop: "1%" }} />
          </View>
