...
<View style={styles.mainContainer}>
    <View style={styles.titleTextRow}>
        <Text style={styles.titleText}>Shrink your footprint, but also grow your hand print!</Text>
    </View>
    ...
    <ScrollView>
        ...
        <View style={styles.itemDivCol1}>
            <Image style={styles.image} source={require("../assets/image-88.png")}/>
        </View>

        <View style={styles.itemDivCol2}>
            <Text style={styles.productTitle}>Drylands Protection, Kasigau Wildlife Corridor £19 / Tonne</Text>
    ...
    <View style={styles.bottom}>
                   <TouchableOpacity style={styles.button}>
                       <Button title="Buy Projects" color="babyBlue"onPress={()=>console.log("Hello Moto")}/>
                   </TouchableOpacity>
   </View>
