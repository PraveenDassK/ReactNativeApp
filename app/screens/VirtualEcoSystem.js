  ...
  return (
    <View style={styles.mainContainer}>
      ...
      <View style={styles.imageBox}>
        <Image
          style={styles.image}
          source={images[forestValue > 49 ? 49 : forestValue].image}
        />
      </View>
      ...
      <View style={styles.centerRow}>
        ...
        <Text style={styles.centerRowSubText}>
          You have planted {forestValue} trees, thank you for helping and fixing
          the environment
        </Text>
      </View>
      ...
      <View style={styles.bottom}>
        <TouchableOpacity style={styles.button}>
          <Button
            title="Buy Projects"
            onPress={() =>
              navigation.navigate("Account", { screen: "CarbonTab" })
            }
          />
        </TouchableOpacity>
      </View>
