...
const ProofOfAuthority = ({ navigation, back = true }) => {
  ...
  const handleSubmit = async () => {
    navigation.navigate("ProofOfStructure");
  };
          ...
          <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            <View style={{ flex: 1, justifyContent: "flex-end" }}>
              ...
              >
                ...
                >
                  <Text style={{ fontSize: 30 }}>{"Proof of ownership"}</Text>
                </View>
                <View
                  style={{
                ...
                >
                  <View style={{ marginBottom: 20 }}>
                    <Text style={{ textAlign: "left" }}>
                      Please provide the proof of your business {"\n"}ownership.
                    </Text>
                  </View>
                  {/* <CountryOfResidence /> */}
