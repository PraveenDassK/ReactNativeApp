...
const AddBeneficiary = ({ navigation }) => {
  ...
  const { darkMode, accountID, customerDetails } = useContext(AuthContext);
  ...
  const loadData = async () => {
    const UserDetails = await apiLogin.GetCustomerDetails(customerDetails);
    console.log(UserDetails.customerDetails, "thsis sis user details");
    setUserData(UserDetails.customerDetails);
  };
  ...
  const navigate = (value) => {
    console.log(value, "in the naviagte");
    ...
    <KeyboardAvoider>
      ...
      >
        ...
        >
          {/* <Text
            style={
              darkMode === "DARK" ? styles.darkheaderLabel : styles.headerLabel
            }
          >
            UserDetails
          </Text> */}
          <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
            ...
            >
              {Object.entries(userData).map((eachValue, i) => {
                return (
                  <View
                    key={i}
                    style={{
                  ...
                  >
                    <View>
                      ...
                      <View>
                        ...
                        >
                          {!eachValue?.[1] ? " " : eachValue?.[1]}
                        </Text>
                      </View>
                    </View>
                    <TouchableOpacity onPress={() => handleEdit(eachValue)}>
                      <Feather
                        name="edit"
                        size={24}
                        color={
