    ...
    >
      <View style={styles.maskGroup261Parent}>
        ...
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/group-306272@3x.png")}
        />
          ...
          >
            ...
            >
              <Image
                ...
                resizeMode="cover"
                source={require("../assets/path-33118123@3x.png")}
              />
              <View
                style={[
                  styles.groupParent,
              ...
              >
                <Image
                  ...
                  resizeMode="cover"
                  source={require("../assets/group-3175911@3x.png")}
                />
                <Image
                  style={[styles.groupInner, styles.groupIconLayout]}
                  resizeMode="cover"
                  source={require("../assets/group-3176012@3x.png")}
                />
                <View style={styles.rectangleView} />
                <Image
                  style={[styles.rectangleIcon, styles.groupIconLayout]}
                  resizeMode="cover"
                  source={require("../assets/rectangle-26204@3x.png")}
                />
            ...
            <Image
              ...
              resizeMode="cover"
              source={require("../assets/group-3176412@3x.png")}
            />
            <Image
              style={styles.groupChild1}
              resizeMode="cover"
              source={require("../assets/group-3176611@3x.png")}
            />
            <Image
              style={[styles.groupChild2, styles.groupChildPosition]}
              resizeMode="cover"
              source={require("../assets/group-3176712@3x.png")}
            />
          ...
          >
            ...
            >
              <Image
                ...
                resizeMode="cover"
                source={require("../assets/path-3311813@3x.png")}
              />
              <View
                style={[
                  styles.groupParent,
              ...
              >
                <Image
                  style={[styles.groupItem, styles.groupIconLayout]}
                  resizeMode="cover"
                  source={require("../assets/group-3175913@3x.png")}
                />
                <Image
                  style={[styles.groupInner, styles.groupIconLayout]}
                  resizeMode="cover"
                  source={require("../assets/group-3176013@3x.png")}
                />
                <View style={styles.rectangleView} />
                <Image
                  style={[styles.rectangleIcon, styles.groupIconLayout]}
            ...
            <Image
              style={styles.groupIcon}
              resizeMode="cover"
              source={require("../assets/group-3176413@3x.png")}
            />
            <Image
              style={styles.groupChild1}
              resizeMode="cover"
              source={require("../assets/group-3176613@3x.png")}
            />
            <Image
              style={[styles.groupChild2, styles.groupChildPosition]}
              resizeMode="cover"
          ...
          >
            ...
            >
              <Image
                ...
                resizeMode="cover"
                source={require("../assets/path-3311814@3x.png")}
              />
              <View
                style={[
                  styles.groupParent,
              ...
              >
                ...
                <Image
                  style={[styles.groupInner, styles.groupIconLayout]}
                  resizeMode="cover"
                  source={require("../assets/group-3176011@3x.png")}
                />
                <View style={styles.rectangleView} />
                <Image
                  style={[styles.rectangleIcon, styles.groupIconLayout]}
            ...
            <Image
              style={styles.groupIcon}
              resizeMode="cover"
              source={require("../assets/group-3176414@3x.png")}
            />
            <Image
              style={styles.groupChild1}
              resizeMode="cover"
            ...
            <Image
              style={[styles.groupChild2, styles.groupChildPosition]}
              resizeMode="cover"
              source={require("../assets/group-3176711@3x.png")}
            />
          </View>
        </Pressable>
      </View>
