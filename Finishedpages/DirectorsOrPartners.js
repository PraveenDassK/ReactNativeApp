    ...
    <View style={styles.directorsOrPartners}>
      <View style={styles.identityProofParent}>
        ...
        >
          ...
          >
            <Text style={styles.current}>Current{"\n"}</Text>
            <Text style={styles.current}>photo-card{"\n"}</Text>
        ...
        >
          <Text style={[styles.birthCertificate, styles.helloTypo]}>
            <Text style={styles.current}>Birth{"\n"}</Text>
        ...
        <TextInput style={[styles.hello3, styles.helloPosition1, styles.helloTypo]} placeholder={"Enter the first name"}>
          
        </TextInput>
        <TextInput style={[styles.hello4, styles.helloPosition1, styles.helloTypo]} placeholder={"Enter the second name"}>
          
        </TextInput>
        <TextInput style={[styles.hello5, styles.helloPosition]} placeholder={"Enter the address line 1"}>
         
        </TextInput>
        <TextInput style={[styles.hello6, styles.helloPosition]} placeholder={"Enter the address line 2"}>
          
        </TextInput>
        <TextInput style={[styles.hello7, styles.helloPosition]} placeholder={"Enter the Town or city"}>
          
        </TextInput>
        <TextInput style={[styles.hello8, styles.helloPosition]} placeholder={"Enter the postcode"}>
        ...
        >
          <TextInput style={[styles.hello, styles.helloTypo]} placeholder={"dd-mm-yyyy"}></TextInput>
        ...
        >
          <Image
            ...
            source={require("../assets/icon-carbonytedownarrow.png")}
          />
          <TextInput style={[styles.hello, styles.helloTypo]} placeholder={"Select the nationality"}>
        ...
        >
          <Image
            ...
            source={require("../assets/icon-carbonytedownarrow.png")}
          />
          <TextInput style={[styles.hello, styles.helloTypo]} placeholder={"Select the country of residence"}>
        ...
        >
          <Image
            ...
            source={require("../assets/icon-carbonytedownarrow.png")}
          />
          <TextInput style={[styles.hello, styles.helloTypo]} placeholder={"Select the role"}></TextInput>
        </View>
        <Pressable
        ...
        >
          ...
          <TextInput style={[styles.hello14, styles.nameTypo]} placeholder={"Continue"}></TextInput>
        </Pressable>
        <Pressable
          style={[
