    ...
    <View style={styles.settings}>
      <View style={styles.path33370Parent}>
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/path-33370@3x.png")}
        />
        ...
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/ellipse-3158@3x.png")}
        />
        <View style={styles.helloParent}>
          ...
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/icon-openaccountlogout@3x.png")}
          />
        </View>
        ...
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/mask-group-241@3x.png")}
        />
        <Image
          style={[
          ...
          resizeMode="cover"
          source={require("../assets/icon-materialcontentcopy@3x.png")}
        />
        <Image
          style={[
