    ...
    <View style={styles.pin}>
      <View style={styles.helloParent}>
        ...
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/group-30766@3x.png")}
        />
        <Image
          style={[styles.groupItem, styles.groupPosition]}
          resizeMode="cover"
          source={require("../assets/ellipse-14@3x.png")}
        />
        <Image
        ...
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/ellipse-15@3x.png")}
        />
        <Image
        ...
        <Image
          ...
          resizeMode="cover"
          source={require("../assets/icon-ionicmdbackspace@3x.png")}
        />
        <Pressable
          style={[
            styles.groupParent,
