  ...
  return (
    ...
    <View style={styles.account1}>
      ...
      <View style={styles.helloParent}>
        <Text style={styles.hello}>Statements</Text>
        <View style={styles.groupParent}>
          <View style={[styles.groupContainer, styles.groupPosition1]}>
            <View style={[styles.groupView, styles.groupShadowBox]}>
              ...
              <Image
                ...
                resizeMode="cover"
                source={require("../assets/mask-group-14@3x.png")}
              />
            </View>
            <View style={[styles.groupParent1, styles.groupParentShadowBox]}>
              ...
              <Image
                style={styles.maskGroup14}
                resizeMode="cover"
                source={require("../assets/mask-group-141@3x.png")}
              />
            </View>
          ...
          <View style={[styles.groupParent5, styles.groupPosition1]}>
            <View style={[styles.groupView, styles.groupShadowBox]}>
              <View style={[styles.lanceBogrolParent, styles.lancePosition]}>
                <Text style={[styles.lanceBogrol, styles.lanceBogrolTypo]}>
                  Grocery Market
