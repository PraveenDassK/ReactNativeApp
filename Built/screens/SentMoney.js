    ...
    >
      <View style={styles.groupView1}>
        <View style={styles.groupView}>
          ...
          <Text style={styles.hello}>Tap anywhere to continue</Text>
        </View>
      </View>
      ...
      <Text style={[styles.hello1, styles.mt32_5, styles.ml1]}>
        <Text style={styles.youveSent}>{`You've sent `}</Text>
        <Text style={styles.text1}>{`£3,420 `}</Text>
        <Text style={styles.to}>{`to `}</Text>
        <Text style={styles.tribeFirst}>Tribe First</Text>
      </Text>
      <Image
        style={[styles.iconAwesomeCheckCircle, styles.mt139_5]}
        resizeMode="cover"
        source={require("../assets/icon-awesomecheckcircle.png")}
      />
      <View style={[styles.groupView3, styles.mt32_5, styles.ml1]}>
        <View style={styles.groupView2} />
        <View style={styles.rectangleView6} />
      </View>
      <View style={[styles.groupView4, styles.mt18_5, styles.ml1]}>
        <Text style={styles.hello2}>
          <Text style={styles.youveUsed1}>
            You've used 1 of your 100 monthly free local
          </Text>
          <Text
            style={styles.transfersAllowance}
          >{`transfers allowance `}</Text>
        </Text>
      </View>
    </Pressable>
  );
