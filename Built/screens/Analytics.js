...
const Analytics = () => {
  ...
  return (
    <View style={styles.analytics}>
      ...
      <View style={[styles.groupView15, styles.mt28, styles.ml25]}>
      ...
      <View style={[styles.groupView19, styles.mt39, styles.ml_2]}>
