...
const ItWasLost = () => {
  ...
  return (
    <View style={styles.itWasLost}>
      ...
      <View style={[styles.groupView2, styles.mt19, styles.ml25]}>
      ...
      <View style={[styles.groupView5, styles.mt10, styles.ml25]}>
      ...
      <View style={[styles.groupView8, styles.mt10, styles.ml25]}>
      ...
      <View style={[styles.groupView10, styles.mt356, styles.ml25]}>
        <View style={styles.component208112}>
