    ...
    <View style={styles.account}>
      <View style={styles.historyParent}>
          ...
          <View style={styles.groupContainer}>
            ...
            <View style={[styles.groupParent2, styles.groupParentShadowBox]}>
              ...
              <Image
                style={styles.maskGroup14}
                resizeMode="cover"
                source={require("../assets/mask-group-1413.png")}
              />
            </View>
        ...
        <View style={[styles.historyContainer, styles.addIconLayout]}>
          <Text style={[styles.history3, styles.historyTypo]}>Account</Text>
          <Text style={[styles.history4, styles.historyTypo]}>Analysis</Text>
          <Text style={[styles.history5, styles.historyTypo]}>Carbon</Text>
          <Text style={[styles.history6, styles.historyTypo]}>Profile</Text>
        </View>
        ...
        >
          ...
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/image-885.png")}
          />
        </Pressable>
      </View>
    </View>
