  ...
  return (
    <View style={styles.address1}>
      <View style={styles.helloParent}>
        ...
        <View style={[styles.towncityWrapper, styles.wrapperBorder]}>
          <Text
            style={[
              styles.towncity,
        ...
        <View style={[styles.postcodeWrapper, styles.wrapperBorder]}>
          <Text
            style={[
              styles.towncity,
              styles.towncityPosition,
        ...
        <View style={[styles.addressLine1Wrapper, styles.wrapperBorder]}>
          <Text
            style={[
              styles.towncity,
              styles.towncityPosition,
        ...
        <View style={[styles.addressLine2Wrapper, styles.wrapperBorder]}>
          <Text
            style={[
              styles.towncity,
              styles.towncityPosition,
