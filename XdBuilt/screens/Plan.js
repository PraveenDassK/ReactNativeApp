...
const Plan = () => {
  ...
  return (
    <View style={styles.plan}>
      <View style={styles.scrollGroup30Parent}>
        <ScrollView
          style={[styles.scrollGroup30, styles.groupPosition1]}
          contentContainerStyle={styles.scrollGroup30Content}
        >
          <View style={styles.component2376}>
            <Text style={[styles.hello, styles.helloFlexBox, styles.helloTypo]}>
              ESSENTIAL
            </Text>
            ...
            <Text
              style={[styles.hello4, styles.helloFlexBox, styles.helloTypo]}
            >
              ADVANCE
            </Text>
            <Text
              style={[styles.hello5, styles.helloFlexBox, styles.helloTypo]}
            >
              ELITE
            </Text>
            <View style={[styles.rectangleParent, styles.groupChildLayout]}>
              ...
              <Text
                style={[styles.geniusMarketPlace, styles.perksCardPosition]}
              >
            ...
            >
              ...
              >
                <Text
                  style={[styles.accountingServicesInvoices, styles.allTypo]}
                >
                  <Text style={styles.accountFeatures}>
                    <Text style={styles.accountFeatures1}>
                      Accounting Services:
            ...
            <View style={[styles.card1, styles.cardLayout]}>
              <View style={[styles.groupParent, styles.groupPosition1]}>
                <View style={[styles.groupParent, styles.groupPosition1]}>
                  ...
                  <View style={[styles.groupParent, styles.groupPosition1]}>
                    <Image
                      ...
                      resizeMode="cover"
                      source={require("../assets/group-3175915.png")}
                    />
                    <Image
                ...
                <Image
                  ...
                  resizeMode="cover"
                  source={require("../assets/group-3176415.png")}
                />
                <Image
                  style={styles.groupChild3}
                  resizeMode="cover"
                  source={require("../assets/group-3176615.png")}
                />
                <Image
                  style={styles.groupChild4}
                  resizeMode="cover"
                  source={require("../assets/group-3176715.png")}
                />
              </View>
            </View>
        ...
        >
          ...
          <Text style={[styles.hello7, styles.helloFlexBox]}>Upgrade Plan</Text>
        </Pressable>
      </View>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  plan: {
    ...
    paddingTop: GlobalStyles.Padding.padding_4xl,
