    ...
    <View style={styles.chooseCardsStandard4}>
      <View style={styles.groupParent}>
        <View style={styles.groupContainer}>
          ...
          <Text style={styles.hello}>PURCHASE pROJECT</Text>
        </View>
        <Image
          style={[styles.groupItem, styles.groupPosition]}
          resizeMode="cover"
          source={require("../assets/group-32041.png")}
        />
        ...
        <View style={[styles.lineParent, styles.groupPosition]}>
          ...
          <Image
            ...
            resizeMode="cover"
            source={require("../assets/group-32039.png")}
          />
        </View>
        <Text style={[styles.hello1, styles.hello1Position]}>
          <Text style={styles.trees}>Shrink your footprint,</Text>
          <Text style={styles.trees}>{`but also grow `}</Text>
          <Text style={styles.trees}>your hand print!</Text>
        </Text>
        <ScrollView
        ...
        >
          <View style={styles.lineGroup}>
            ...
            <Text style={[styles.text5, styles.textTypo]}>15</Text>
            <Image
              style={[styles.ellipseIcon, styles.groupChildPosition]}
              resizeMode="cover"
              source={require("../assets/ellipse-3344.png")}
            />
            <Image
            ...
            <Text style={[styles.text7, styles.textTypo1]}>25</Text>
            <Text style={[styles.text8, styles.textTypo]}>30</Text>
            <Image
...
export default ChooseCardsStandard4;
