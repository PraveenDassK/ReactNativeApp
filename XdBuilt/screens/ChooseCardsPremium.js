...
const ChooseCardsPremium = () => {
  ...
  return (
    <View style={styles.chooseCardsPremium}>
      <View style={styles.component2374Parent}>
        <Pressable
          style={[styles.component2374, styles.parentPosition]}
            ...
            <View style={[styles.groupParent, styles.parentPosition]}>
              <View style={[styles.groupParent, styles.parentPosition]}>
                <Image
                  ...
                  resizeMode="cover"
                  source={require("../assets/path-331181.png")}
                />
                <View style={[styles.groupParent, styles.parentPosition]}>
                  <Image
                    style={[styles.groupIcon, styles.groupIconLayout]}
        ...
        <Pressable
          style={styles.component2353}
          onPress={() => navigation.navigate("ChooseCardsElite")}
        >
          <Text style={[styles.hello8, styles.helloTypo]}>Standard</Text>
          <Text style={[styles.hello9, styles.helloTypo, styles.helloColor]}>
            Premium
          </Text>
          <Text style={[styles.hello10, styles.helloTypo]}>Elite</Text>
        </Pressable>
      </View>
    </View>
  );
