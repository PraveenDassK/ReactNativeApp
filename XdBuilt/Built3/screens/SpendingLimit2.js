  ...
  return (
    <View style={styles.spendingLimit2}>
      ...
      <View style={[styles.rectangleParent, styles.mt63, styles.ml1]}>
        ...
        <View style={[styles.component22415, styles.component22415Position]}>
          <View style={styles.component22415Child} />
          <Image
            style={[styles.component22415Item, styles.itemLayout]}
            resizeMode="cover"
