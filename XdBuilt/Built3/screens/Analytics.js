...
const Analytics = () => {
  ...
  return (
    <View style={styles.analytics}>
      ...
      <Text
        style={[styles.hello8, styles.mt27, styles.ml25, styles.hello8Typo]}
      >
        Analytics
      </Text>
      <View style={[styles.groupParent1, styles.mt37, styles.ml25]}>
        <View style={[styles.rectangleParent, styles.rectangleParentPosition]}>
          ...
          <Image
            style={[styles.bagShoppingSolidIcon, styles.iconPosition2]}
            resizeMode="cover"
        ...
        <View style={[styles.lanceBogrolParent, styles.lanceParentPosition]}>
          <Text style={[styles.lanceBogrol4, styles.lanceTypo]}>Spendings</Text>
          <Image
      ...
      <View style={[styles.analyticsInner, styles.mt28, styles.ml_2]}>
        <View style={styles.path23773Parent}>
          ...
          <View style={[styles.lineView, styles.iconPosition2]} />
          <Image
          ...
          />
          <Image
            style={[styles.groupChild2, styles.iconPosition2]}
            resizeMode="cover"
      ...
      <View style={[styles.groupParent6, styles.mt52, styles.ml25]}>
        ...
        <View style={[styles.groupParent9, styles.groupParentShadowBox]}>
          <View style={[styles.groupParent10, styles.groupParentPosition]}>
            ...
            <View
              style={[styles.moneyTransferWrapper, styles.groupChild1Layout]}
            >
      ...
      <View style={[styles.component2124, styles.mt_1733, styles.ml33]}>
        <Pressable
...
const styles = StyleSheet.create({
  ...
  rectanglePosition: {
    borderBottomLeftRadius: GlobalStyles.Border.br_2xl,
    borderTopLeftRadius: GlobalStyles.Border.br_2xl,
    bottom: 0,
    left: 0,
    top: 0,
    position: "absolute",
