...
const ChooseCardsElite = () => {
  ...
  return (
    <Pressable
      style={styles.chooseCardsElite}
      onPress={() => navigation.navigate("ChooseCardsStandard")}
    >
      <View style={styles.rectangleView} />
      <Pressable
        style={[styles.component2375, styles.mt30, styles.ml_724]}
        onPress={() => navigation.navigate("ChooseCardsStandard")}
      >
      ...
      <View style={[styles.groupView76, styles.mt300, styles.ml_2414]}>
        ...
        <View style={styles.groupView58}>
          ...
          <View style={styles.groupView57}>
            ...
            <Image
              ...
              resizeMode="cover"
              source={require("../assets/group-306245.png")}
            />
            <Image
        ...
        <View style={styles.groupView71}>
          <View style={styles.component20891}>
        ...
        <View style={styles.groupView73}>
          <View style={styles.component20892}>
        ...
        <View style={styles.groupView75}>
          <View style={styles.component20893}>
      ...
      >
        <View style={styles.component20894}>
      ...
      <View style={[styles.statusBarBlack, styles.mt12]}>
