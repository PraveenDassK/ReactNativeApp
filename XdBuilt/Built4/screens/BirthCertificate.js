...
const BirthCertificate = () => {
  ...
  return (
    <View style={styles.birthCertificate}>
      <View style={styles.birthCertificateChild} />
      <Text
        style={[
      ...
      <View style={[styles.component1977, styles.mt9, styles.ml1]}>
        <View
          style={[
            styles.component1977Child,
            styles.component1977ChildBorder,
      ...
      <Text
        style={[
          styles.takeAPictureOfYourBirthC,
          styles.mt105,
          styles.ml1,
          styles.helloColor,
        ]}
      >
        ...
        <Text style={styles.takeAPicture}>Birth Certificate</Text>
      </Text>
      <Image
        style={[styles.birthCertificateItem, styles.mt34, styles.ml1]}
        resizeMode="cover"
...
const styles = StyleSheet.create({
  ...
  takeAPictureOfYourBirthC: {
    textAlign: "center",
    fontSize: GlobalStyles.FontSize.size_base,
  },
  birthCertificateItem: {
    width: 48,
    height: 48,
  },
  icon: {
