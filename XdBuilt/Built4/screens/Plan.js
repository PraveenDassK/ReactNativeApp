  ...
  return (
    <View style={styles.plan}>
            ...
            <View style={[styles.groupParent, styles.parentPosition]}>
              <View style={[styles.groupParent, styles.parentPosition]}>
                ...
                <View style={[styles.groupParent, styles.parentPosition]}>
                  ...
                  <Text style={[styles.business, styles.text11FlexBox]}>
                    BUSINESS
                  </Text>
                </View>
              </View>
      ...
      <View style={[styles.statusBarBlack, styles.mt_2495]}>
        <View style={[styles.rectangle, styles.groupShadowBox]} />
        <View style={[styles.statusBar, styles.statusBarPosition]}>
          <View style={[styles.time, styles.parentPosition]}>
            <Text style={[styles.text11, styles.text11FlexBox]}>9:41</Text>
          </View>
          <Image
