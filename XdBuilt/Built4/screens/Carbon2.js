...
const Carbon2 = () => {
  ...
  return (
    <View style={styles.carbon2}>
      <View style={[styles.carbon2Child, styles.mt_50]} />
      <Text
        style={[
          styles.hello,
          styles.mt41,
      ...
      />
      <View style={[styles.carbon2Item, styles.mt_272, styles.ml100]} />
      <View
        style={[
          styles.helloWrapper,
          styles.mt32,
      ...
      <View style={[styles.component208162Parent, styles.mt258, styles.ml1]}>
        <View style={[styles.component208162, styles.rectanglePosition]}>
      ...
      <Text style={[styles.yourTypo, styles.mt42, styles.helloColor]}>
        Select your project
      </Text>
      ...
      <View style={[styles.rectangleGroup, styles.mt21, styles.ml1]}>
        ...
        <View
          style={[
            ...
            styles.groupChildLayout4,
            styles.groupChildPosition17,
          ]}
        />
        <View style={[styles.rectangleView, styles.groupChild8Position]} />
        <View style={[styles.groupChildLayout2, styles.groupChildPosition16]} />
        ...
        <View style={[styles.groupChild5, styles.groupChildLayout3]} />
        ...
        <View
          style={[styles.groupChildPosition13, styles.groupChildPosition16]}
        />
        <View
          style={[
            styles.groupChild10,
        ...
        />
        <View style={[styles.groupChild13, styles.groupChildPosition16]} />
        <View
          style={[
            styles.groupChild14,
        ...
        <View style={[styles.component21433, styles.componentPosition]}>
          <View style={[styles.component208162, styles.rectanglePosition]}>
            <View style={[styles.groupChild, styles.historyPosition]} />
            <View style={styles.maskGroup236} />
          </View>
      ...
      <View style={[styles.groupView, styles.mt885, styles.ml1]}>
        <View style={styles.groupItem} />
        <View style={[styles.groupChildPosition10, styles.groupChildLayout4]} />
        <View style={[styles.groupChildPosition9, styles.groupChildLayout4]} />
        <View style={[styles.groupChildPosition8, styles.groupChildLayout2]} />
        <View
          style={[
            styles.groupChild20,
        ...
        <Text style={[styles.coBenefits1, styles.benefitsTypo]}>
          Co-benefits
        </Text>
        <View style={[styles.component21434, styles.componentPosition]}>
          <View style={[styles.component208162, styles.rectanglePosition]}>
            <View style={[styles.groupChild, styles.historyPosition]} />
            <View style={styles.maskGroup236} />
          </View>
      ...
      <View style={[styles.rectangleParent2, styles.mt36, styles.ml1]}>
        ...
        <View style={[styles.groupChild30, styles.groupChildLayout3]} />
        <View
          style={[
            styles.groupChild31,
        ...
        />
        <View style={[styles.groupChild34, styles.groupChildLayout3]} />
        ...
        <Text style={[styles.coBenefits2, styles.benefitsTypo]}>
          Co-benefits
        </Text>
        <View style={[styles.component21441, styles.componentPosition]}>
          <View style={[styles.component208162, styles.rectanglePosition]}>
            <View style={[styles.groupChild, styles.historyPosition]} />
            <View style={styles.maskGroup236} />
          </View>
      ...
      <View style={[styles.rectangleParent4, styles.mt36, styles.ml1]}>
        ...
        <View style={[styles.groupChild43, styles.groupChildLayout3]} />
        ...
        <Text style={[styles.coBenefits3, styles.benefitsTypo]}>
          Co-benefits
        </Text>
        <View style={[styles.component21442, styles.componentPosition]}>
          <View style={[styles.component208162, styles.rectanglePosition]}>
            <View style={[styles.groupChild, styles.historyPosition]} />
            <View style={styles.maskGroup236} />
          </View>
      ...
      <View style={[styles.rectangleParent6, styles.mt36, styles.ml1]}>
        ...
        <Text style={[styles.coBenefits4, styles.benefitsTypo]}>
          Co-benefits
        </Text>
        ...
        <View style={[styles.component21443, styles.componentPosition]}>
          <View style={[styles.component208162, styles.rectanglePosition]}>
            <View style={[styles.groupChild, styles.historyPosition]} />
            <View style={styles.maskGroup236} />
          </View>
      ...
      <View style={[styles.rectangleParent8, styles.mt36, styles.ml1]}>
        ...
        <View style={[styles.soilHealthWrapper, styles.groupChildLayout3]}>
        ...
        <View style={[styles.waterSecurityWrapper, styles.groupChildLayout3]}>
          <Text style={[styles.fishNurseries, styles.trainingPosition1]}>
            water security
          </Text>
        </View>
        ...
        <Text style={[styles.coBenefits5, styles.benefitsTypo]}>
          Co-benefits
        </Text>
        ...
        <View style={[styles.component21444, styles.componentPosition]}>
          <View style={[styles.component208162, styles.rectanglePosition]}>
            <View style={[styles.groupChild, styles.historyPosition]} />
            <View style={styles.maskGroup236} />
          </View>
      ...
      <View style={[styles.rectangleParent10, styles.mt36, styles.ml1]}>
        ...
        <View
          style={[styles.educationInvestmentWrapper, styles.groupChildLayout3]}
        >
          <Text style={[styles.endangeredSpecies2, styles.trainingPosition1]}>
            education investment
          </Text>
        ...
        <View
          style={[styles.sustainableIncomeContainer, styles.groupChildLayout3]}
        >
          <Text style={[styles.womenEmpowered2, styles.womenPosition]}>
            sustainable income
          </Text>
        ...
        <View style={[styles.endangeredSpeciesFrame, styles.groupChildLayout3]}>
          <Text
            style={[styles.biodiversityProtection1, styles.trainingPosition1]}
          >
            endangered species
        ...
        <Text style={[styles.coBenefits6, styles.benefitsTypo]}>
          Co-benefits
        </Text>
        <View style={[styles.component21445, styles.componentPosition]}>
          <View style={[styles.component208162, styles.rectanglePosition]}>
            <View style={[styles.groupChild, styles.historyPosition]} />
            <View style={styles.maskGroup236} />
          </View>
      ...
      <View style={[styles.rectangleParent12, styles.mt36, styles.ml1]}>
        ...
        <View style={[styles.foodSecurityFrame, styles.groupChildLayout3]}>
          <Text style={[styles.foodSecurity2, styles.foodPosition]}>
            food security
          </Text>
        </View>
        <View style={[styles.womenEmpoweredFrame, styles.groupChildLayout3]}>
          <Text style={[styles.womenEmpowered3, styles.womenPosition]}>
            women empowered
          </Text>
        </View>
        ...
        <Text style={[styles.coBenefits7, styles.benefitsTypo]}>
          Co-benefits
        </Text>
        <View style={[styles.component21446, styles.componentPosition]}>
          <View style={[styles.component208162, styles.rectanglePosition]}>
            <View style={[styles.groupChild, styles.historyPosition]} />
            <View style={styles.maskGroup236} />
          </View>
      ...
      <Image
        ...
        resizeMode="cover"
        source={require("../assets/twotrees.png")}
      />
      <Pressable
        style={[styles.component208162Parent, styles.mt53, styles.ml1]}
      ...
      <View style={[styles.component21227, styles.mt_7489, styles.mr15]}>
        <Pressable
          style={[styles.history1, styles.historyPosition]}
          onPress={() => navigation.navigate("Account")}
        >
          <Text style={[styles.account, styles.carbonTypo]}>Account</Text>
        </Pressable>
        <Pressable
          style={styles.history2}
          onPress={() => navigation.navigate("Analytics")}
        >
          <Text style={[styles.account, styles.carbonTypo]}>Analysis</Text>
        </Pressable>
        <Pressable
          style={styles.history3}
          onPress={() => navigation.navigate("Carbon")}
        >
          <Text style={[styles.carbon, styles.carbonTypo]}>Carbon</Text>
        </Pressable>
        <Pressable
          style={styles.history4}
          onPress={() => navigation.navigate("Settings")}
        >
          <Text style={[styles.account, styles.carbonTypo]}>Profile</Text>
        </Pressable>
      </View>
      <View
        style={[
      ...
      >
        ...
        <View style={[styles.rectangleParent16, styles.rectanglePosition]}>
          <View style={[styles.groupChild67, styles.groupChildPosition]} />
          <Text
            style={[styles.text18, styles.text18Typo, styles.rectanglePosition]}
          >
            1
          </Text>
        </View>
      ...
      <View style={[styles.homeIndicator, styles.mt_51, styles.ml1]} />
      <View style={[styles.statusBarBlack, styles.mt41]}>
        ...
        <View style={[styles.statusBar, styles.statusBarPosition]}>
          <View style={[styles.time, styles.rectanglePosition]}>
            <Text style={styles.text19}>9:41</Text>
          </View>
          <Image
      ...
      <Pressable
        style={[styles.wrapper, styles.mt_21, styles.ml319]}
        onPress={() => navigation.navigate("CarbonCart1")}
      >
        <Image
          style={styles.icon}
          resizeMode="cover"
          source={require("../assets/group-32050.png")}
        />
      </Pressable>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  mr108: {
    marginRight: GlobalStyles.Margin.margin_48xl,
  },
  mt31: {
    marginTop: GlobalStyles.Margin.margin_md,
  },
  mt_272: {
    marginTop: GlobalStyles.Margin.margin_80xs,
  },
  ml100: {
  ...
  mt258: {
    marginTop: GlobalStyles.Margin.margin_87xl,
  },
  mt23: {
  ...
  mt_77: {
    marginTop: GlobalStyles.Margin.margin_70xs,
  },
  mr213: {
  ...
  mt885: {
    marginTop: GlobalStyles.Margin.margin_97xl,
  },
  mt36: {
    marginTop: GlobalStyles.Margin.margin_6xl,
  },
  mt_854: {
    marginTop: GlobalStyles.Margin.margin_93xs,
  },
  mt45: {
    marginTop: GlobalStyles.Margin.margin_16xl,
  },
  ml165: {
    marginLeft: GlobalStyles.Margin.margin_67xl,
  },
  mt53: {
    marginTop: GlobalStyles.Margin.margin_22xl,
  },
  mt_7489: {
    marginTop: GlobalStyles.Margin.margin_97xs,
  },
  mr15: {
