...
const Biometrix2 = () => {
  ...
  return (
    <Pressable
      style={styles.biometrix2}
      onPress={() => navigation.navigate("BiometrixComplete")}
    >
      <View style={styles.biometrix2Child} />
      <Pressable
      ...
      <Image
        style={[styles.biometrix2Item, styles.mt_225, styles.ml119]}
        resizeMode="cover"
        source={require("../assets/group-125.png")}
      />
      <View style={[styles.homeIndicator, styles.mt160, styles.ml121]} />
      <View style={[styles.parent, styles.mt123, styles.ml153]}>
      ...
      <Image
        style={[styles.biometrix2Inner, styles.mt99, styles.ml49]}
        resizeMode="cover"
