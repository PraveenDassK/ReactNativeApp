...
const BankBuildingsocietymortgage = () => {
  ...
  return (
    <View style={styles.bankBuildingsocietymortgage}>
      ...
      <View style={[styles.component19712, styles.mt9, styles.ml1]}>
        <View
          style={[
            styles.component19712Child,
            styles.component19712ChildBorder,
      ...
      >
        ...
        <Text style={styles.takeAPicture}>
          Bank, building society, mortgage or
        </Text>
        <Text style={styles.takeAPicture}>HMRC tax statement</Text>
      </Text>
      <Pressable
...
export default BankBuildingsocietymortgage;
