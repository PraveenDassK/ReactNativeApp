...
const ChooseCardsPremium = () => {
  ...
  return (
    <View style={styles.chooseCardsPremium}>
      <View style={[styles.chooseCardsPremiumChild, styles.mt_10]} />
      <Pressable
      ...
      >
        ...
        <Text style={[styles.hello33, styles.helloTypo4]}>Premium</Text>
        <Text style={[styles.hello34, styles.hello34Position]}>Elite</Text>
      </Pressable>
